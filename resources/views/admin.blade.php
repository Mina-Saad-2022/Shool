                ...
                <div class="row">
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{route('teacher.index')}}"
                               class="small-box-footer">{{ __('auth.more_info')}}<i
                    ...
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{route('student.index')}}" class="small-box-footer">{{ __('auth.more_info')}}<i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-secondary">
                            ...
                            <a href="{{route('user.index')}}" class="small-box-footer">{{ __('auth.more_info')}}<i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
